    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body text-center">
            ...
            <?php if(isset($_SESSION['user_id']) && $_SESSION['user_id'] == $user['id_user']): ?>
                <a href="index.php?page=profile_edit" class="btn btn-outline-dark btn-sm mb-3">
