            ...
            <?php foreach ($posts as $p): ?>
                <div class="col-12 col-md-4 mb-4">
                    <div class="card shadow-sm h-100 position-relative">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        if (isset($_SESSION['user_id'])) {
                                            $isLiked = hasLiked($_SESSION['user_id'], $p['id_post']);
                                        }
                                        ?>
                                        ...
                                        <button class="btn btn-link text-secondary p-0 dislike-btn" title="Masquer ce post">
                        ...
                        <div class="post-overlay d-none d-flex flex-column justify-content-center align-items-center text-center p-5" style="height: 300px;">
                            <i class="fas fa-eye-slash fa-3x text-muted mb-3"></i>
                            <p class="text-muted fw-bold">Le post a été masqué pour je ne sais quelle raison.</p>
                            <button class="btn btn-sm btn-outline-dark undo-btn">Réafficher</button>
                        </div>
